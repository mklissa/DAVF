...
class MlpPolicy(object):
    ...
    def act(self, stochastic, ob):
        ac1, vpred1, sigmapred1 =  self._act(stochastic, ob[None])
        return ac1[0], vpred1[0], sigmapred1[0]

    def get_vpreds(self, obs, stochastic=False):
        ac1, vpred1, sigmapred1 =  self._act(stochastic, obs)
        return vpred1
